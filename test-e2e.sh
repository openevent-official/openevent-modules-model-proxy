...
GRPC_ADDR="${OPENEVENT_MODEL_PROXY_E2E_GRPC_ADDR:-127.0.0.1:39527}"
ADMIN_ADDR="${OPENEVENT_MODEL_PROXY_E2E_ADMIN_ADDR:-127.0.0.1:39528}"
...
export OPENEVENT_MODEL_PROXY_E2E=1
export OPENEVENT_MODEL_PROXY_E2E_TARGET="$GRPC_ADDR"
export OPENEVENT_MODEL_PROXY_E2E_ADMIN_TARGET="$ADMIN_ADDR"
export OPENEVENT_MODEL_PROXY_E2E_TMP="$TMP_WORK_DIR"
...
while time.time() < deadline:
    try:
        AdminClient(os.environ["OPENEVENT_MODEL_PROXY_E2E_ADMIN_TARGET"]).list_tokens()
        break
...
cd "$ROOT_DIR"
"$PYTHON_BIN" -m unittest tests.test_e2e "$@"
